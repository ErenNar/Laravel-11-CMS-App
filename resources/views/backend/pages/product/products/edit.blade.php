                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ route('updateProducts', $productID->id) }}"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputTitle"
                                                            name="name" value="{{ $productID->name ?? null }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $productID->short_text ?? null }}"
                                                            placeholder="Category Content">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputPageContent">Product Content</label>
                                                        <textarea name="content" id="editor" value="{{ $productID->content ?? null }}"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        @if (!empty($productID->image))
                                                            <img src="{{ '/uploads/' . $productID->image }}"
                                                                alt="{{ $productID->name }}">
                                                        @endif
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    class="form-control" id="exampleInputPageContent"
                                                                    name="quantity" placeholder="Category Content">
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="exampleInputPageContent">Product Price</label>
                                                                <input type="text" value="{{ $productID->price ?? '' }}"
                                                                    class="form-control" id="exampleInputPageContent"
                                                                    name="price" placeholder="Category Content">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <select class="form-control" name="size"
                                                            ...
                                                            <option value="{{ $productID->size }}" selected>
                                                                {{ $productID->size }} </option>
                                                    ...
                                                    <div class="form-group">
                                                        <select class="form-control" name="color"
                                                            id="exampleFormControlSelect1">
                                                            <option value="{{ $productID->color }}" selected>
                                                                {{ $productID->color }} </option>
                                        ...
                                        <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="slug" id="pageSlug"
                                                    value="{{ $productID->slug }}" placeholder="Page Slug">
                                            </div>
                                            <!--
                                                                        <div class="form-group">
